...
public class LoginActivity extends AppCompatActivity {
    ...
    private void tryLoggingIn(){
        ...
        if(passwordStr.equals("") || userIDStr.equals("")){
            ...
            android.widget.Toast.makeText(this, "Please enter User ID and Password", android.widget.Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private void failed(){
        ...
        android.widget.Toast.makeText(this, "Login failed. Check credentials or network.", android.widget.Toast.LENGTH_LONG).show();
    }
